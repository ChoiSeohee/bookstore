		...
		<div class="col-md-12">
			...
			<div class="box box-primary">
				<div class="box-header">
					<h3 class="box-title">책정보 수정화면</h3>
				</div>
				<!-- /.box-header -->
					...
					<div class="box-body">
						...
						<div class="form-group">
							<label for="exampleInputEmail1">BOOK TITLE</label> <input type="text"
								name='bookTitle' class="form-control" value="${boardVO.bookTitle}">
						</div>
						...
						<div class="form-group">
							<label for="exampleInputEmail1">PUBLICATION_DATE</label> <input type="text"
								name='publication_date' class="form-control" value="${boardVO.publication_date}">
						</div>
						
						<div class="form-group">
							<label for="exampleInputEmail1">PRICE</label> <input type="text"
								name='price' class="form-control" value="${boardVO.price}">
						</div>
						
						
						<div class="form-group">
							<label for="exampleInputEmail1">ISBN</label> <input type="text"
								name='isbn' class="form-control" value="${boardVO.isbn}">
						</div>
